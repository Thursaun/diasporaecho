        ...
        >
          ...
          <div className="relative z-10 text-center mb-3">
            ...
            <div className="flex items-center justify-center gap-2">
              <span className="inline-block px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-medium bg-secondary/20 text-secondary border border-secondary/30">
                {categories[0] || occupation[0] || "Historical Figure"}
              </span>
              {displayYears && (
                <span className="text-[10px] sm:text-xs text-gray-400">{displayYears}</span>
              )}
            </div>
          </div>

          {/* Achievements List - No scroll, fill available space */}
          <div className="relative z-10 flex-1 overflow-hidden">
            <div className="flex items-center gap-1.5 mb-1.5">
              ...
              <span className="text-[10px] font-semibold text-amber-400 uppercase tracking-wide">Key Achievements</span>
            </div>
              ...
              {(() => {
                ...
                if (achievements.length >= 2) {
                  return achievements.slice(0, 4).map((item, i) => (
                    <li key={i} className="flex items-start gap-1.5">
                      ...
                      <span className="text-[11px] sm:text-xs text-gray-300 leading-snug">
                        {item.text}
                      </span>
                    </li>
                  ));
                ...
                if (sentences.length >= 2) {
                  return sentences.map((sentence, i) => (
                    <li key={i} className="flex items-start gap-1.5">
                      <span className="text-secondary mt-0.5 flex-shrink-0 text-xs">•</span>
                      <span className="text-[11px] sm:text-xs text-gray-300 leading-snug">
                        {sentence.replace(/[.!?]$/, '')}
                      </span>
                    </li>
          ...
          <div className="relative z-10 flex justify-center mt-3 pt-3 border-t border-white/10">
            <button
